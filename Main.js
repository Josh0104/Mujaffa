...
function setup() {
  ...
  background(100);
   ...
   buttonInfoX = width/2 - 150;
   buttonInfoY = height/2 + 5;
      ...
      if (pointy - 100 > py ) { // Hvis du misser point
        Point1.point1(random(width/2-200,width/2+200),0)
          ...
          if (liv == 3) {
            ...
            console.log("Hello my dearest friend")
...
function startSkaerm() {
  ...
  // buttonInfo = createButton("Instruktioner");
  // buttonInfo.mousePressed(infoKnap);
  // buttonInfo.size(300,100);
  // buttonInfo.position(buttonInfoX,buttonInfoY);
  // buttonInfo.style("font-family", "Bodoni");
  // buttonInfo.style("font-size", "48px");
  // buttonInfo.style('background-color', color('rgb(255)'));
